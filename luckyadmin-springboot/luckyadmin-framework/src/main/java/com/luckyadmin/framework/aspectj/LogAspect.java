package com.luckyadmin.framework.aspectj;
...
import com.luckyadmin.common.enums.BusinessStatus;
import com.luckyadmin.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.luckyadmin.common.annotation.Log)")
