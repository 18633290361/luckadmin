package com.luckyadmin.framework.shiro.realm;
...
import com.luckyadmin.common.exception.user.RoleBlockedException;
...
import com.luckyadmin.common.exception.user.UserPasswordRetryLimitExceedException;
...
public class UserRealm extends AuthorizingRealm
{
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException
    {
        ...
        SysUser user = null;
        try {
            if (username.equals("#qqOpenId")) {
                String qqOpenId = password;
                user = loginService.qqLogin(qqOpenId);
            }else{
